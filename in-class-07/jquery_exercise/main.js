...
- When clicked, the link will cross out the current task (hint: add a class to
...
- Bonus: when user completes task, remove the task from the current list and add it to a completed
  list below. Do not show this list unless the there are completed items.
...
$('<a href="#">Task Complete</a>').appendTo($thingList 'li');
